...
async def start() -> cl.Message:
    ...
    while True:
        ...
        if answer(prompt_satisfied["content"]) == "positive":
            while True:
                ...
                if answer(image_satisfied["content"]) == "positive":
                    download = await ask_user_msg(
                        "Thank You! Do you want to Download this image?"
                    )
                    ...
                    await cl.Message(content="Okay, Thank You").send()
                    break
            break
            ...
            await cl.Message(content="Thank You, Bye Bye").send()
            break
...
async def download_image(image_url):
    ...
    await cl.Message(content="Thank you, check the image in ImageDALL-E folder").send()
